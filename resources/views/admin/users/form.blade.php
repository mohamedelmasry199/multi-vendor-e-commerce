        ...
        <div id="kt_content_container" class="container">
            <div id="kt_app_toolbar" class="app-toolbar py-3 py-lg-6">
                <div id="kt_app_toolbar_container" class="app-container container-xxl d-flex flex-stack">
                    ...
                    <div class="d-flex align-items-center gap-2 gap-lg-3">
                        <a href="{{ route('admin.user.index') }}" class="btn btn-primary">{{ __('View Users') }}</a>
                    </div>
                </div>
            </div>
            ...
            <div class="card mb-5 mb-xxl-10">
                ...
                <div id="kt_account_profile_details" class="collapse show">
                    <form id="kt_account_profile_details_form" class="form" method="POST" action="{{ isset($user) ? (Route::currentRouteName() == 'admin.user.edit' ? route('admin.user.update', $user->id) : '#') : route('admin.user.store') }}" enctype="multipart/form-data">
                        @csrf
                        @if(isset($user) && Route::currentRouteName() == 'admin.user.edit')
                            @method('PUT')
                        @endif
                        <div class="card-body border-top p-9">
                            ...
                            <div class="row mb-6">
                                ...
                                <div class="col-lg-8 fv-row">
                                    <input type="text" name="name" class="form-control form-control-lg form-control-solid" placeholder="{{ __('Full Name') }}" value="{{ isset($user) ? $user->name : old('name') }}" {{ Route::currentRouteName() == 'admin.user.show' ? 'readonly' : '' }} />
                                </div>
                            </div>
                            ...
                            <div class="row mb-6">
                                ...
                                <div class="col-lg-8 fv-row">
                                    <input type="email" name="email" class="form-control form-control-lg form-control-solid" placeholder="{{ __('Email') }}" value="{{ isset($user) ? $user->email : old('email') }}" {{ Route::currentRouteName() == 'admin.user.show' ? 'readonly' : '' }} />
                                </div>
                            </div>
                            ...
                            <div class="row mb-6">
                                ...
                                <div class="col-lg-8 fv-row">
                                    <input type="text" name="phone" class="form-control form-control-lg form-control-solid" placeholder="{{ __('Phone') }}" value="{{ isset($user) ? $user->phone : old('phone') }}" {{ Route::currentRouteName() == 'admin.user.show' ? 'readonly' : '' }} />
                                </div>
                            </div>
                            ...
                            <div class="row mb-6">
                                ...
                                <div class="col-lg-8 fv-row">
                                    <input type="text" name="address" class="form-control form-control-lg form-control-solid" placeholder="{{ __('Address') }}" value="{{ isset($user) ? $user->address : old('address') }}" {{ Route::currentRouteName() == 'admin.user.show' ? 'readonly' : '' }} />
                                </div>
                            </div>

                            @if(Route::currentRouteName() == 'admin.user.create' || Route::currentRouteName() == 'admin.user.edit')
                                <div class="row mb-6">
