            ...
            <div class="app-navbar flex-shrink-0">
                ...
                <div class="app-navbar-item ms-1 ms-md-3" id="kt_header_user_menu_toggle">
                    ...
                    <div class="cursor-pointer symbol symbol-30px symbol-md-40px" data-kt-menu-trigger="{default: 'click', lg: 'hover'}" data-kt-menu-attach="parent" data-kt-menu-placement="bottom-end">
                        <img src="{{ auth()->guard('admin')->user()->image }}" alt="user" />
                    </div>
                    ...
                    <div class="menu menu-sub menu-sub-dropdown menu-column menu-rounded menu-gray-800 menu-state-bg menu-state-color fw-semibold py-4 fs-6 w-275px" data-kt-menu="true">
                        ...
                        <div class="menu-item px-3">
                            <div class="menu-content d-flex align-items-center px-3">
                                ...
                                <div class="d-flex flex-column">
                                    ...
                                    <div class="fw-semibold text-muted text-hover-primary fs-9">{{ auth()->guard('admin')->user()->email }}</div>
                                </div>
                                <!--end::Username-->
                            </div>
                        </div>
                        ...
                        <div class="menu-item px-5">
                            <a href="{{ route('admin.profile.index') }}" class="menu-link px-5">{{ __('My Profile') }}</a>
                        </div>
                        <!--end::Menu item-->
                        ...
                        <div class="menu-item px-5" data-kt-menu-trigger="{default: 'click', lg: 'hover'}" data-kt-menu-placement="left-start" data-kt-menu-offset="-15px, 0">
                            <a href="#" class="menu-link px-5">
                                <span class="menu-title position-relative">{{ __('Language') }}
                                    <span class="fs-8 rounded bg-light px-3 py-2 position-absolute translate-middle-y top-50 end-0">
                                        ...
                                        <img class="w-15px h-15px rounded-1 ms-2" src="{{ asset('assets/media/flags/' . (app()->getLocale() === 'ar' ? 'egypt.svg' : 'united-states.svg')) }}" alt="" />
                                    </span>
                                </span>
                            </a>
                            <!--begin::Menu sub-->
                            <div class="menu-sub menu-sub-dropdown w-175px py-4">
                                <!--begin::Menu item-->
                                <div class="menu-item px-3">
                                    <a href="{{ route('setLocale', 'en') }}" class="menu-link d-flex px-5 {{ app()->getLocale() === 'en' ? 'active' : '' }}">
                                ...
                                <!--begin::Menu item-->
                                <div class="menu-item px-3">
                                    <a href="{{ route('setLocale', 'ar') }}" class="menu-link d-flex px-5 {{ app()->getLocale() === 'ar' ? 'active' : '' }}">
                                        <span class="symbol symbol-20px me-4">
